            ...
            <div className='absolute w-[100%]  -top-[3.958vw]'>
                ...
                <div className='absolute inset-0 '>
                    <div className='ml-[15.937vw] mt-[12.969vw] w-[72.500vw] h-[33.176vw] flex  '>
                        <img className='w-[15.521vw] h-[33.176vw]' src={phone_img} />
                        <div className='ml-[9.635vw] mt-[6.458vw] w-[47.760vw] h-[20.159vw] flex flex-col'>
                            ...
                            <div className='mt-[1.823vw] w-[25.473vw] h-[10.315vw] '>
                                ...
                                <div className='mt-[3.411vw] w-[25.469vw] h-[3.646vw] flex justify-between '>
                                    <button className=''><img className='w-[11.615vw] h-[3.646vw]' src={download_apple}/></button>
                                    <button className=''><img className='w-[11.615vw] h-[3.646vw]' src={download_google}/></button>
                                </div>
                            </div>
                        </div>
